 ...
 */
import { LIQ_NFT_CONTRACTS } from "./liquidus/config/NFTConfigs";
...
export const PROJECT_CONFIGS = [
    { name: "LIQ", contracts: LIQ_CONTRACTS, tokenBNBContract: LiquidusBNBContract, nftContracts:  LIQ_NFT_CONTRACTS},
    { name: "ONI", contracts: ONI_CONTRACTS, tokenBNBContract: OniBNBContract, nftContracts: [] }
]